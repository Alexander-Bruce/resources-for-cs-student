...
cpu mcpu(.data_in(rambus),.clk_quick(clk_quick),.clk_slow(clk_slow),.clk_delay(clk_delay),.rst(rst),.SW_choose(SW_choose),.A1(A1),.cpustate(cpustate),
			.addr(addr),.data_out(data),.r0dbus(r0dbus),.r1dbus(r1dbus),.r2dbus(r2dbus),.r3dbus(r3dbus),.clr(clr),.irout(irout),
				.arload(arload),.arinc(arinc),.pcload(pcload),.pcinc(pcinc),.pcbus(pcbus),.drload(drload),.drhbus(drhbus),.drlbus(drlbus),
				.irload(irload),.trload(trload),.trbus(trbus),.r0load(r0load),.r0bus(r0bus),.r1load(r1load),.r1bus(r1bus),.r2load(r2load),
				.r2bus(r2bus),.r3load(r3load),.r3bus(r3bus),.xload(xload),.yload(yload),.ybus(ybus),.zload(zload),.read(read),.write(write),
				.membus(membus),.busmem(busmem),.zout(Z));
...
/*
assign rd = ( (irout[7:4]==4'b0001) || (irout[7:4]==4'b0010) || (irout[7:4]==4'b0011) || (irout[7:4]==4'b0100) || (irout[7:4]==4'b0101) || (irout[7:4]==4'b0110) || (irout[7:4]==4'b0111) || (irout[7:4]==4'b1000) || (irout[7:4]==4'b1001) || (irout[7:4]==4'b1010) || (irout[7:4]==4'b1110) ) ? ( (irout[3:2]==2'b00) ? r0dbus:8'bzzzzzzzz ) : 8'bzzzzzzzz;
assign rd = ( (irout[7:4]==4'b0001) || (irout[7:4]==4'b0010) || (irout[7:4]==4'b0011) || (irout[7:4]==4'b0100) || (irout[7:4]==4'b0101) || (irout[7:4]==4'b0110) || (irout[7:4]==4'b0111) || (irout[7:4]==4'b1000) || (irout[7:4]==4'b1001) || (irout[7:4]==4'b1010) || (irout[7:4]==4'b1110) ) ? ( (irout[3:2]==2'b01) ? r1dbus:8'bzzzzzzzz ) : 8'bzzzzzzzz;
assign rd = ( (irout[7:4]==4'b0001) || (irout[7:4]==4'b0010) || (irout[7:4]==4'b0011) || (irout[7:4]==4'b0100) || (irout[7:4]==4'b0101) || (irout[7:4]==4'b0110) || (irout[7:4]==4'b0111) || (irout[7:4]==4'b1000) || (irout[7:4]==4'b1001) || (irout[7:4]==4'b1010) || (irout[7:4]==4'b1110) ) ? ( (irout[3:2]==2'b10) ? r2dbus:8'bzzzzzzzz ) : 8'bzzzzzzzz;
assign rd = ( (irout[7:4]==4'b0001) || (irout[7:4]==4'b0010) || (irout[7:4]==4'b0011) || (irout[7:4]==4'b0100) || (irout[7:4]==4'b0101) || (irout[7:4]==4'b0110) || (irout[7:4]==4'b0111) || (irout[7:4]==4'b1000) || (irout[7:4]==4'b1001) || (irout[7:4]==4'b1010) || (irout[7:4]==4'b1110) ) ? ( (irout[3:2]==2'b11) ? r3dbus:8'bzzzzzzzz ) : 8'bzzzzzzzz;
*/

//assign Z = zload ? zload : 0;
...
case(irout[7:4])
	...
	case(irout[3:2])
		...
		2'b10:rd = r2dbus;
		2'b11:rd = r3dbus;
		default:rd = 8'bzzzzzzzz;
	endcase
	
	default:rd = 8'b00000000;
endcase	
...
/*
assign rs = ( (irout[7:4]==4'b0001) || (irout[7:4]==4'b0010) || (irout[7:4]==4'b0011) || (irout[7:4]==4'b0100) || (irout[7:4]==4'b1001) || (irout[7:4]==4'b1111) ) ? ( (irout[7:4]==4'b1111) ? ( (irout[3:2]==2'b00) ? r0dbus : 8'bzzzzzzzz ) : ( (irout[1:0]==2'b00) ? r0dbus : 8'bzzzzzzzz) ) : 8'bzzzzzzzz;
assign rs = ( (irout[7:4]==4'b0001) || (irout[7:4]==4'b0010) || (irout[7:4]==4'b0011) || (irout[7:4]==4'b0100) || (irout[7:4]==4'b1001) || (irout[7:4]==4'b1111) ) ? ( (irout[7:4]==4'b1111) ? ( (irout[3:2]==2'b01) ? r1dbus : 8'bzzzzzzzz ) : ( (irout[1:0]==2'b01) ? r1dbus : 8'bzzzzzzzz) ) : 8'bzzzzzzzz;
assign rs = ( (irout[7:4]==4'b0001) || (irout[7:4]==4'b0010) || (irout[7:4]==4'b0011) || (irout[7:4]==4'b0100) || (irout[7:4]==4'b1001) || (irout[7:4]==4'b1111) ) ? ( (irout[7:4]==4'b1111) ? ( (irout[3:2]==2'b10) ? r2dbus : 8'bzzzzzzzz ) : ( (irout[1:0]==2'b10) ? r2dbus : 8'bzzzzzzzz) ) : 8'bzzzzzzzz;
assign rs = ( (irout[7:4]==4'b0001) || (irout[7:4]==4'b0010) || (irout[7:4]==4'b0011) || (irout[7:4]==4'b0100) || (irout[7:4]==4'b1001) || (irout[7:4]==4'b1111) ) ? ( (irout[7:4]==4'b1111) ? ( (irout[3:2]==2'b11) ? r3dbus : 8'bzzzzzzzz ) : ( (irout[1:0]==2'b11) ? r3dbus : 8'bzzzzzzzz) ) : 8'bzzzzzzzz;
*/
